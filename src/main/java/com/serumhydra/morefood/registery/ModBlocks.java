...
public class ModBlocks {
    public static final Block BACON_BLOCK = new Block(FabricBlockSettings.of(Material.PLANT).breakByTool(FabricToolTags.HOES)
            .strength(5f, 15f).sounds(BlockSoundGroup.CROP));
